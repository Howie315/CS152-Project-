...
prog_start:
      functions 
      {
            ...
            // Gracefully fails if continue found outside of loop
            if (code_node->code.find("CONTINUE_REPLACE") != std::string::npos) {
                  yyerror("Error: continue found outside of loop.");
            }

            // Gracefully fails if break found outside of loop
            if (code_node->code.find("BREAK_REPLACE") != std::string::npos) {
                  yyerror("Error: break found outside of loop.");
            }
